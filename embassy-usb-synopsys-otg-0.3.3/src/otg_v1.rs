...
pub mod regs {
    ...
    impl Doepint {
        ...
        #[doc = "Status Phase Received (control write)"]
        #[inline(always)]
    ...
    impl Ghwcfg2 {
        ...
        #[doc = "Architecture (0=slave-only, 1=ext DMA, 2=int DMA, 3=int+ext DMA)"]
        #[inline(always)]
        pub const fn arch(&self) -> u8 {
    ...
    impl Hcdma {
        ...
        pub fn set_qtdaddr(&mut self, val: u32) {
            core::debug_assert!(
                val & 0xFFFFFE00 == val,
                "QTD list needs to be 512 byte aligned"
            );
