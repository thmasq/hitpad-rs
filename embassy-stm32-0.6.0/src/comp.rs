        ...
        T::regs().csr().modify(|w| {
            ...
            #[cfg(comp_v2)]
            {
                w.set_scalen(matches!(
                    inmsel,
                    vals::Inm::QUARTER_VREF
                        | vals::Inm::HALF_VREF
                        | vals::Inm::THREE_QUARTER_VREF
                        | vals::Inm::VREF
                ));
                w.set_brgen(matches!(
                    inmsel,
    ...
    ($inst:ident, $exti_line:expr) => {
        impl SealedInstance for crate::peripherals::$inst {
            ...
            fn enable_exti_interrupt() {
                ...
                #[cfg(any(
                    exti_c0, exti_g0, exti_u0, exti_l5, exti_u5, exti_u3, exti_h5, exti_h50,
                    exti_n6
                ))]
...
macro_rules! impl_comp_inp_pin {
    ($inst:ident, $pin:ident, $ch:expr) => {
        ...
        impl crate::comp::SealedInputPlusPin<crate::peripherals::$inst>
...
macro_rules! impl_comp_inm_pin {
    ($inst:ident, $pin:ident, $ch:expr) => {
        ...
        impl crate::comp::SealedInputMinusPin<crate::peripherals::$inst>
            for crate::peripherals::$pin
        {
            fn channel(&self) -> u8 {
                $ch
