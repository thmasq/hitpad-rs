        ...
        match self.info().dma {
            ...
            DmaInfo::Dma(r) => {
                ...
                let ndtr = match (mem_size, peri_size) {
                    ...
                    (WordSize::EightBytes, _) | (_, WordSize::EightBytes) => {
                        unimplemented!("invalid word size")
                    }
                };
            ...
            DmaInfo::Mdma(r) => {
                ...
                let (sinc, dinc) = match (incr_mem, dir) {
                    ...
                    (Increment::Peripheral, Dir::PeripheralToMemory) => {
                        (Incmode::INCREMENT, Incmode::FIXED)
                    }
                    (Increment::Peripheral, Dir::MemoryToPeripheral) => {
                        (Incmode::FIXED, Incmode::INCREMENT)
                    }
                    (Increment::Memory, Dir::PeripheralToMemory) => {
                        (Incmode::FIXED, Incmode::INCREMENT)
                    }
                    (Increment::Memory, Dir::MemoryToPeripheral) => {
                        (Incmode::INCREMENT, Incmode::FIXED)
                    }
                };
