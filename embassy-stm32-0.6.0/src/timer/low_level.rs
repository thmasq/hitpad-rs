...
pub use stm32_metapac::timer::vals::{
    FilterValue, Mms as MasterMode, Sms as SlaveMode, Ts as TriggerSource,
};
...
impl From<OutputCompareMode> for crate::pac::timer::vals::Ocm {
    fn from(mode: OutputCompareMode) -> Self {
        match mode {
            ...
            #[cfg(timer_v2)]
            OutputCompareMode::OnePulseMode1 => {
                crate::pac::timer::vals::Ocm::RETRIGERRABLE_OPM_MODE_1
            }
            #[cfg(timer_v2)]
            OutputCompareMode::OnePulseMode2 => {
                crate::pac::timer::vals::Ocm::RETRIGERRABLE_OPM_MODE_2
            }
            #[cfg(timer_v2)]
            OutputCompareMode::CombinedPwmMode1 => {
                crate::pac::timer::vals::Ocm::COMBINED_PWM_MODE_1
            }
            #[cfg(timer_v2)]
            ...
            #[cfg(timer_v2)]
            OutputCompareMode::AsymmetricPwmMode1 => {
                crate::pac::timer::vals::Ocm::ASYMMETRIC_PWM_MODE_1
            }
            #[cfg(timer_v2)]
            OutputCompareMode::AsymmetricPwmMode2 => {
                crate::pac::timer::vals::Ocm::ASYMMETRIC_PWM_MODE_2
            }
        }
    }
}
...
impl<'d, T: CoreInstance> Timer<'d, T> {
    ...
    pub fn generate_update_event(&self) {
        self.regs_core()
            .cr1()
            .modify(|r| r.set_urs(vals::Urs::COUNTER_ONLY));
        self.regs_core().egr().write(|r| r.set_ug(true));
        self.regs_core()
            .cr1()
            .modify(|r| r.set_urs(vals::Urs::ANY_EVENT));
    }
    ...
    pub(crate) fn set_period_clocks_internal(
        &self,
        clocks: u64,
        round: RoundTo,
        max_arr_bits: usize,
...
impl<'d, T: GeneralInstance4Channel> Timer<'d, T> {
    ...
    pub fn setup_channel_update_dma<
        'a,
        C: TimerChannel,
        W: Word + Into<T::Word>,
        D: super::Dma<T, C>,
...
impl<'d, T: AdvancedInstance1Channel> Timer<'d, T> {
    ...
    pub fn set_break_comparator_enable(&self, comp_index: usize, enable: bool) {
        self.regs_1ch_cmp()
            .af1()
            .modify(|w| w.set_bkcmpe(comp_index, enable));
    }
    ...
    pub fn set_break_comparator_polarity(&self, comp_index: usize, polarity: vals::Bkinp) {
        self.regs_1ch_cmp()
            .af1()
            .modify(|w| w.set_bkcmpp(comp_index, polarity));
    }
...
impl<'d, T: AdvancedInstance4Channel> Timer<'d, T> {
    ...
    pub fn set_break2_comparator_enable(&self, comp_index: usize, enable: bool) {
        self.regs_advanced()
            .af2()
            .modify(|w| w.set_bk2cmpe(comp_index, enable));
    }
            ...
            for round in [RoundTo::Slower, RoundTo::Faster] {
                ...
                for (psc_delta, arr_delta) in mutations {
                    ...
                    if satisfies_constraint {
                        ...
                        let our_distance =
                            (config.actual_period_clocks as i64 - period_clocks as i64).abs();
