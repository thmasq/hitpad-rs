...
impl<'d, T: AdvancedInstance4Channel, C: TimerChannel, #[cfg(afio)] A>
    if_afio!(ComplementaryPwmPin<'d, T, C, A>)
{
    ...
    pub fn new(
        ...
        critical_section::with(|_| {
            ...
            set_as_af!(
                pin,
                AfType::output(output_type, crate::gpio::Speed::VeryHigh)
            );
        });
        ComplementaryPwmPin {
            pin: Flex::new(pin),
...
impl<'d, T: AdvancedInstance4Channel> ComplementaryPwm<'d, T> {
    ...
    pub fn set_break_comparator_polarity(
        &mut self,
        comp_index: usize,
        polarity: BreakComparatorPolarity,
    ) {
        self.inner
            .set_break_comparator_polarity(comp_index, polarity);
    }
    ...
    pub fn set_break2_comparator_polarity(
        &mut self,
        comp_index: usize,
        polarity: BreakComparatorPolarity,
    ) {
        self.inner
            .set_break2_comparator_polarity(comp_index, polarity);
    }
    ...
    pub fn set_frequency(&mut self, freq: Hertz) {
        ...
        self.inner
            .set_period_clocks_internal(clocks, RoundTo::Slower, 16);
    }
    ...
    pub fn set_duty(&mut self, channel: Channel, duty: u32) {
        ...
        self.inner
            .set_compare_value(channel, unwrap!(duty.try_into()))
    }
    ...
    pub async fn waveform<C: TimerChannel, W: Word + Into<T::Word>, D: super::Dma<T, C>>(
        ...
        self.inner
            .setup_channel_update_dma(dma, irq, channel, duty)
            .await;
