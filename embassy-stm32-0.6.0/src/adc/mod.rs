...
#[cfg(any(
    adc_v2, adc_v3, adc_g0, adc_h5, adc_h7rs, adc_u0, adc_v4, adc_u3, adc_u5, adc_wba, adc_g4,
    adc_c0
))]
...
pub(crate) trait SealedAdcChannel<T> {
    #[cfg(any(
        adc_v1, adc_c0, adc_l0, adc_v2, adc_g4, adc_v3, adc_v4, adc_u5, adc_u3, adc_wba
    ))]
    fn setup(&mut self) {}
...
#[cfg(any(
    adc_c0, adc_v3, adc_g0, adc_h5, adc_h7rs, adc_u0, adc_v4, adc_u5, adc_u3
))]
...
#[cfg(any(
    adc_v2, adc_g4, adc_v3, adc_g0, adc_h5, adc_h7rs, adc_u0, adc_v4, adc_u5, adc_u3, adc_wba,
    adc_c0
))]
...
impl<'d, T: Instance> Adc<'d, T> {
    #[cfg(any(
        adc_v2, adc_g4, adc_v3, adc_g0, adc_h5, adc_h7rs, adc_u0, adc_u3, adc_u5, adc_v3, adc_v4,
        adc_wba, adc_c0
    ))]
    /// Read an ADC pin.
    ...
    pub async fn read<'a, 'b: 'a, D: RxDma<T>>(
        ...
        sequence: impl ExactSizeIterator<
            Item = (
                &'a mut AnyAdcChannel<'b, T>,
                <T::Regs as BasicAdcRegs>::SampleTime,
            ),
        >,
        readings: &mut [u16],
    ) {
        ...
        T::regs().configure_sequence(sequence.map(|(channel, sample_time)| {
            ((channel.channel, channel.is_differential), sample_time)
        }));
        ...
        let transfer =
            unsafe { dma_channel.read(request, T::regs().data(), readings, Default::default()) };
    ...
    pub fn into_ring_buffered<'a, 'b, D: RxDma<T>>(
        ...
        + 'a,
        sequence: impl ExactSizeIterator<
            Item = (AnyAdcChannel<'b, T>, <T::Regs as BasicAdcRegs>::SampleTime),
        >,
...
/// ADC instance.
#[cfg(not(any(
    adc_f1, adc_v1, adc_l0, adc_v2, adc_v3, adc_v4, adc_g4, adc_f3v1, adc_f3v2, adc_g0, adc_u0,
    adc_h5, adc_h7rs, adc_u5, adc_u3, adc_c0, adc_wba,
)))]
#[allow(private_bounds)]
...
pub trait AdcChannel<T>: SealedAdcChannel<T> + Sized {
    ...
    {
        #[cfg(any(
            adc_v1, adc_l0, adc_v2, adc_g4, adc_v3, adc_v4, adc_u3, adc_u5, adc_wba
        ))]
        self.setup();
...
pub const fn resolution_to_max_count(res: Resolution) -> u32 {
    match res {
        ...
        #[cfg(any(
            adc_v1, adc_v2, adc_v3, adc_l0, adc_c0, adc_g0, adc_f3v1, adc_f3v2, adc_h5
        ))]
