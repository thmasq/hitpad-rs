...
impl MasterFilters<'_> {
    ...
    pub fn set_split(&mut self, split_index: u8) -> &mut Self {
        ...
        self.info
            ...
            .0
            .fmr()
            .modify(|reg| reg.set_can2sb(split_index));
...
impl FilterBanks {
    ...
    fn enable(&mut self, index: u8, fifo: Fifo, config: BankConfig) {
        ...
        self.info
            ...
            .0
            .fm1r()
            .modify(|reg| reg.set_fbm(index as usize, mode));
        ...
        self.info
            ...
            .0
            .fs1r()
            .modify(|reg| reg.set_fsc(index as usize, scale));
        ...
        self.info
            ...
            .0
            .fa1r()
            .modify(|reg| reg.set_fact(index as usize, true))
    }
}
