...
impl<'d, T: Instance> Pka<'d, T> {
    ...
    pub fn ecdsa_verify(
        ...
        self.write_ram_word(
            offsets::ecdsa_verif::IN_A_COEFF_SIGN,
            curve.a_coefficient_sign,
        );
    ...
    pub fn ecdsa_sign(
        ...
        self.write_ram_word(
            offsets::ecdsa_sign::IN_A_COEFF_SIGN,
            curve.a_coefficient_sign,
        );
        ...
        // Read signature
        self.read_operand(
            offsets::ecdsa_sign::OUT_SIGNATURE_R,
            &mut signature_r[..order_size],
        );
        self.read_operand(
            offsets::ecdsa_sign::OUT_SIGNATURE_S,
            &mut signature_s[..order_size],
        );
    ...
    pub fn ecc_mul(
        ...
        // Read result
        self.read_operand(
            offsets::ecc_mul::OUT_RESULT_X,
            &mut result.x[..modulus_size],
        );
        self.read_operand(
            offsets::ecc_mul::OUT_RESULT_Y,
    ...
    pub fn point_check(
        ...
        self.write_ram_word(
            offsets::point_check::IN_A_COEFF_SIGN,
            curve.a_coefficient_sign,
        );
    ...
    fn arithmetic_op(
        ...
        let result_size = if mode == PkaMode::ArithmeticMul {
            size * 2
        } else {
            size
        };
    ...
    pub fn modular_exp_protect(
        ...
        self.read_operand(
            offsets::modular_exp_protect::OUT_RESULT,
            &mut result[..mod_size],
        );
    ...
    pub fn ecc_complete_add(
        ...
        self.write_ram_word(
            offsets::ecc_complete_add::IN_A_COEFF_SIGN,
            curve.a_coefficient_sign,
        );
        ...
        // Read result
        self.read_operand(
            offsets::ecc_complete_add::OUT_RESULT_X,
            &mut result.x[..modulus_size],
        );
        self.read_operand(
            offsets::ecc_complete_add::OUT_RESULT_Y,
            &mut result.y[..modulus_size],
        );
        self.read_operand(
            offsets::ecc_complete_add::OUT_RESULT_Z,
            &mut result.z[..modulus_size],
        );
    ...
    pub fn double_base_ladder(
        ...
        self.write_ram_word(
            offsets::double_base_ladder::IN_PRIME_ORDER_NB_BITS,
            order_nb_bits,
        );
        self.write_ram_word(offsets::double_base_ladder::IN_MOD_NB_BITS, mod_nb_bits);
        self.write_ram_word(
            offsets::double_base_ladder::IN_A_COEFF_SIGN,
            curve.a_coefficient_sign,
        );
        ...
        // Write point P
        self.write_operand(
            offsets::double_base_ladder::IN_POINT1_X,
            &p.x[..modulus_size],
        );
        self.write_operand(
            offsets::double_base_ladder::IN_POINT1_Y,
            &p.y[..modulus_size],
        );
        self.write_operand(
            offsets::double_base_ladder::IN_POINT1_Z,
            &p.z[..modulus_size],
        );

        // Write point Q
        self.write_operand(
            offsets::double_base_ladder::IN_POINT2_X,
            &q.x[..modulus_size],
        );
        self.write_operand(
            offsets::double_base_ladder::IN_POINT2_Y,
            &q.y[..modulus_size],
        );
        self.write_operand(
            offsets::double_base_ladder::IN_POINT2_Z,
            &q.z[..modulus_size],
        );
        ...
        self.read_operand(
            offsets::double_base_ladder::OUT_RESULT_X,
            &mut result.x[..modulus_size],
        );
        self.read_operand(
            offsets::double_base_ladder::OUT_RESULT_Y,
            &mut result.y[..modulus_size],
        );
    ...
    pub fn projective_to_affine(
        ...
        for (i, &word) in montgomery_param.iter().enumerate() {
            self.write_ram_word(
                offsets::projective_to_affine::IN_MONTGOMERY_PARAM + i * 4,
                word,
            );
        }
        ...
        self.write_operand(
            offsets::projective_to_affine::IN_POINT_X,
            &point.x[..modulus_size],
        );
        self.write_operand(
            offsets::projective_to_affine::IN_POINT_Y,
            &point.y[..modulus_size],
        );
        self.write_operand(
            offsets::projective_to_affine::IN_POINT_Z,
            &point.z[..modulus_size],
        );
