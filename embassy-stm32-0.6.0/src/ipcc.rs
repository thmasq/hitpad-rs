...
impl<'a> IpccChannel<'a> {
    ...
    pub const fn split(self) -> (IpccTxChannel<'a>, IpccRxChannel<'a>) {
        (
            IpccTxChannel::new(self.index),
            IpccRxChannel::new(self.index),
        )
    }
}
...
impl Ipcc {
    ...
    pub fn new<'d>(
        ...
        _irq: impl interrupt::typelevel::Binding<
            interrupt::typelevel::IPCC_C1_RX,
            ReceiveInterruptHandler,
        > + interrupt::typelevel::Binding<
            interrupt::typelevel::IPCC_C1_TX,
    ...
    pub fn new<'d>(
        _peripheral: Peri<'d, crate::peripherals::IPCC>,
        _irq: impl interrupt::typelevel::Binding<
            interrupt::typelevel::IPCC_C2_RX_C2_TX,
            InterruptHandler,
        > + 'd,
        _config: Config,
    ) -> Self {
